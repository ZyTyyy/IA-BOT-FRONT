...
function App() {
  ...
  // ✅ AJOUT : topic actif pour suggestions
  ...
  // ✅ AJOUT : suggestions par topic (1 à 2 questions)
  const topicSuggestions: Record<Topic, string[]> = {
    budget: [
      "J’ai un budget de 1200€ pour 7 jours, quelle destination me conseilles-tu ?",
      "Peux-tu estimer le budget total (vol + hôtel) pour Bangkok en janvier 2026 ?",
    ],
    dates: [
      "Je veux partir en janvier 2026, quelle destination est idéale ?",
      "Trouve-moi des vols Paris → Bangkok pour janvier 2026.",
    ],
    airline: [
      "Je veux un vol Paris → Bangkok en janvier 2026, quel prix environ ?",
      "Peux-tu comparer des options de vols (durée / prix) ?",
    ],
    destination: [
      "Je veux une destination chaude en janvier 2026, tu proposes quoi ?",
      "Quelle est la meilleure période pour visiter Lisbonne ?",
    ],
    hotel: [
      "Je cherche un hôtel à Bangkok en janvier 2026, quels prix ?",
      "Trouve-moi une idée de prix d’hôtel à Lisbonne en mai 2026.",
    ],
    weather: [
      "Quelle est la météo actuelle à Bangkok ?",
      "Quel climat fait-il généralement à Lisbonne en avril ?",
    ],
  };
  ...
  // ✅ AJOUT : clic suggestion -> remplit le textarea + focus
  ...
  return (
    <div className="app">
        ...
        <main className="conversation">
          <div className="conversation-grid">
            <section className="prompt-card">
              ...
              {/* ✅ AJOUT : suggestions de questions au-dessus du chat */}
              {activeTopic && (
                <div className="topic-suggestions">
                  <p className="topic-suggestions-title">
                    Idées de questions ({activeTopic}) :
                  </p>
                  <div className="topic-suggestions-chips">
                    {topicSuggestions[activeTopic].slice(0, 2).map((q, idx) => (
                      <button
                        key={idx}
                        type="button"
      ...
      {/* ✅ FAQ uniquement sur la page Accueil */}
